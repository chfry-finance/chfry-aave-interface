...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  [CustomMarket.proto_kovan]: {
    ...
    addresses: {
      ...
      // 自己部署的
      LENDING_POOL_ADDRESS_PROVIDER: '0x8bD206df9853d23bE158A9F7065Cf60A7A5F05DF'.toLowerCase(),
      LENDING_POOL: '0x57110816Db545D4A3910dDba38fB17221a8EB506',
      WETH_GATEWAY: '0xD1774E644a8e48eE18E25299f1329A19c7Dc5B63',
      FAUCET: '0x600103d518cC5E8f3319D532eB4e5C268D32e604', //duke 无用！！
    },
  },
