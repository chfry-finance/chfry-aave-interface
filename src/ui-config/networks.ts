...
export const networkConfigs: Record<string, BaseNetworkConfig> = {
  [ChainId.kovan]: {
    ...
    addresses: {
      //duke 这几个都是部署了100多天了
      // walletBalanceProvider: '0x07DC923859b68e9399d787bf52c4Aa9eBe3490aF', //官方的
    ...
    protocolDataUrl: 'https://api.thegraph.com/subgraphs/name/aave/protocol-v2-kovan', // duke 自己的
    // baseUniswapAdapter: '0xf86Be05f535EC2d217E4c6116B3fa147ee5C05A1', //这是官方的
    baseUniswapAdapter: '0x5A88CCf2a7C0adA99ef602570a9864c195cc818B', //duke 自己部署
    baseAsset: 'ETH',
    ...
    rewardTokenAddress: '0xb597cd8d3217ea6477232f9217fa70837ff667af', //duke 先不管
